 ...
 */
function isShowOnDate(show: TVMazeShow, date: string): boolean {
 ...
 */
function isShowFromCountry(show: TVMazeShow, country: string): boolean {
...
async function fetchTvShows({
    ...
    try {
        ...
        const shows = [...tvResponse, ...webResponse].map(normalizeShowData).filter((show): show is Show => show !== null);
